package com.yuny.demo1.my.test;
...
public class CryptionUtil {
        ...
        public static void main(String [] args) throws Exception {
            String pwd="4149496e6b3857474c466b465530526b7269655676513d3d";
            System.out.println(CryptionUtil.decode(pwd));
            System.out.println(CryptionUtil.encode("Aa123456"));
        }
